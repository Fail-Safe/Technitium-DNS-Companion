        ...
        {nodeId && (
          <>
                          ...
                          return (
                            ...
                            >
                              ...
                              >
                                ...
                                >
                                  {viewExpandedZoneDetails.has(entry.zoneName) ?
                                    "Hide details"
                                  : "Details"}
                                </button>
                              </div>
            ...
            <div className="snapshot-drawer__warning">
              Restoring overwrites the full contents of the selected zone(s). If
              "Keep zones" is unchecked, selected zones that did not exist at
              snapshot time may be deleted. Pinned snapshots are not removed by
              retention cleanup.
            </div>
            ...
            {!loading && !error && sortedSnapshots.length === 0 && (
              <SnapshotDrawerEmptyState
                message={
                  "Capture the current DNS zones to enable quick rollback. Pinned snapshots never expire during retention cleanup."
                }
              />
            )}
