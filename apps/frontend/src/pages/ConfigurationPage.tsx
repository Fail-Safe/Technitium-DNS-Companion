...
export function ConfigurationPage() {
    ...
    const [hasUnsavedListSourcesChanges, setHasUnsavedListSourcesChanges] =
        useState(false);
    const [hasUnsavedDomainChanges, setHasUnsavedDomainChanges] =
        useState(false);
    ...
    const advancedNodes = advancedBlocking?.nodes ?? [];
    const builtInNodes = builtInBlocking?.nodes ?? [];
    ...
    useEffect(() => {
        const nodesForMethod =
            selectedBlockingMethod === "built-in" ? builtInNodes : (
                availableNodes
            );
    ...
    useEffect(() => {
        ...
        for (const groupName of allGroupNames) {
            ...
            if (!group1 && group2) {
                ...
                const isDifferentContent =
                    ...
                    !compareUrlArrays(
                        group1.blockListUrls,
                        group2.blockListUrls,
                    ) ||
                    !compareUrlArrays(
                        group1.allowListUrls,
                        group2.allowListUrls,
                    ) ||
                    !compareUrlArrays(
                    ...
                    !compareStringArrays(
                        group1.adblockListUrls,
                        group2.adblockListUrls,
                    );
                ...
                const isDifferentSettings =
                    !compareSettingValues(
                        group1.enableBlocking,
                        group2.enableBlocking,
                    ) ||
                    !compareSettingValues(
        ...
        if (
            node1.config!.blockingAnswerTtl !== node2.config!.blockingAnswerTtl
        ) {
            configDiffsCount++;
        }
        ...
        if (
            ...
            !localKeys1.every(
                (key, i) =>
                    key === localKeys2[i] &&
                    localMappings1[key] === localMappings2[key],
            )
        ) {
            configDiffsCount++;
        }
    ...
    const handleRemoveFromGroup = useCallback(
        (domain: string, groupName: string) => {
            ...
            const group = updatedConfig.groups.find(
                (g) => g.name === groupName,
            );
            if (!group) return;
    ...
    useEffect(() => {
        if (
            ...
            if (foundIn.length > 0) {
                ...
                const allGroups = [
                    ...new Set(foundIn.map((item) => item.groupName)),
                ];
    ...
    const handleConfirmEdit = useCallback(() => {
        if (!editingDomain || !testStagedConfig || !editDomainInput.trim())
            return;
            ...
            <section ref={pullToRefresh.containerRef} className="configuration">
                <header className="configuration__header">
                    <div>
                        <h1>DNS Filtering</h1>
                        <p>
                            Configure DNS filtering rules, groups, and sync
                ...
                <BlockingMethodSelector
                    ...
                    hasAdvancedBlocking={nodes.some(
                        (n) => n.hasAdvancedBlocking,
                    )}
                    hasBuiltInBlocking={
                        blockingStatus?.nodes?.some((n) => n.builtInEnabled) ??
                        false
                    }
                />
                ...
                <BlockingConflictBanner
                    ...
                    conflictingNodes={blockingStatus?.nodes?.filter(
                        (n) => n.hasConflict,
                    )}
                    onDismiss={() => {
                    ...
                    <section className="configuration__editors">
                        ...
                        {builtInNodes.length > 0 && (
                            <NodeSelector
                                ...
                                overrideCounts={
                                    builtInCountsOverride ?? undefined
                                }
                            />
                        )}
                        ...
                        {availableNodes.length > 0 && (
                            <div className="configuration__tab-switcher">
                                <button
                                    ...
                                    onClick={() =>
                                        handleTabChange("domain-management")
                                    }
                                >
                                    <span>Domains</span>
                                </button>
                                <button
                                    ...
                                    onClick={() =>
                                        handleTabChange("group-management")
                                    }
                                >
                                    <span>Groups</span>
                                </button>
                                <button
                                    ...
                                    onClick={() =>
                                        handleTabChange("list-management")
                                    }
                                >
                                    <span>Lists</span>
                                </button>
                            ...
                            <section className="configuration-editor configuration-editor--stacked">
                                <header className="configuration-editor__header advanced-blocking-summary__actions">
                                    <div className="configuration-editor__title">
                                        ...
                                        <p>
                                            Create and manage filtering groups.
                                            Configure global settings, network
                                            mappings, and group-specific
                                            blocking behavior.
                                        </p>
                                    </div>
                                </header>
                                ...
                                <section className="configuration-editor configuration-editor--stacked">
                                    <header className="configuration-editor__header">
                                        <div className="configuration-editor__title">
                                            ...
                                            <p>
                                                Manage blocklist URLs, allowlist
                                                URLs, and filter lists across
                                                multiple groups.
                                            </p>
                                        </div>
                                    </header>
                                    <ListSourceEditor
                                        ...
                                        onDirtyChange={
                                            setHasUnsavedListSourcesChanges
                                        }
                                        disabled={
                                            loadingAdvancedBlocking ||
                                            !selectedNodeConfig
                                ...
                                <section className="configuration-editor configuration-editor--stacked">
                                    <header className="configuration-editor__header">
                                        <div className="configuration-editor__title">
                                            ...
                                            <p>
                                                Search for domains or add new
                                                ones with drag & drop to groups.
                                            </p>
                                        </div>
                                    </header>
                                                        ...
                                                        <>
                                                            ...
                                                            {(() => {
                                                                ...
                                                                if (
                                                                    ...
                                                                    testStagedConfig.groups.forEach(
                                                                        (
                                                                            group,
                                                                        ) => {
                                                                            if (
                                                                                group.allowed?.includes(
                                                                                    searchedDomain,
                                                                                )
                                                                            ) {
                                                                                blockedInGroups.delete(
                                                                                    group.name,
                                                                                );
                                                                            }
                                                                        },
                                            ...
                                            <div className="domain-management-right">
                                                ...
                                                >
                                                    <p className="drop-zone-hint">
                                                        ...
                                                        />
                                                        Drag domains to groups
                                                        to add them, or drag
                                                        from expanded groups to
                                                        remove.
                                                    </p>
                ...
                >
                    ...
                    >
                        ...
                        <p className="modal__description">
                            ...
                            <code className="modal__code">
                                {deletingDomain.domain}
                            </code>{" "}
                            from{" "}
                            <strong>
                                {deletingDomain.groups.length} group(s)
                            </strong>
                            ?
                        </p>
