...
// === Frontend-only parsed shape (before normalization) ===
export interface UnifiedImportData {
  AdvancedBlocking: {
    ...
    domainGroups?: Record<string, {
      description?: string;
      entries?: Array<{ value: string; note?: string }>;
      regexEntries?: Array<{ value: string; note?: string }>;
    }>;
  };
}
