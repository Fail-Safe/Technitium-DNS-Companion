...
export class BlockListCatalogService {
  ...
  private cache: { data: HageziUpdateCheckResult | null; timestamp: number } = {
    data: null,
    timestamp: 0,
  };
  ...
  private parseHageziReadme(readme: string): HageziListInfo[] {
    ...
    const wildcardPattern =
      /\[Link\]\((https:\/\/cdn\.jsdelivr\.net\/gh\/hagezi\/dns-blocklists@latest\/wildcard\/([a-z0-9.-]+)-onlydomains\.txt)\)/gi;
    ...
    > = {
      light: {
        name: "Hagezi Light",
        description: "Basic protection - Ads, Tracking, Metrics",
        category: "multi",
      },
      multi: {
        name: "Hagezi Normal",
        description: "All-round protection - Ads, Tracking, Malware, Scam",
        category: "multi",
      },
      pro: {
        name: "Hagezi Pro",
      ...
      tif: {
        ...
        description: "Malware, Phishing, Scam, Spam",
        category: "security",
      },
      "tif.medium": {
        name: "Hagezi TIF Medium",
        description: "Threat Intelligence - Medium version",
        category: "security",
      },
      "tif.mini": {
        name: "Hagezi TIF Mini",
        description: "Threat Intelligence - Mini version",
        category: "security",
      },
      fake: {
        name: "Hagezi Fake",
        description: "Protects against internet scams, traps & fakes",
        category: "security",
      },
      popupads: {
      ...
      "gambling.medium": {
        ...
        description: "Gambling - Medium version",
        category: "content",
      },
      "gambling.mini": {
        name: "Hagezi Gambling Mini",
        description: "Gambling - Mini version",
        category: "content",
      },
      nsfw: {
      ...
      "anti.piracy": {
        ...
        description: "Blocks piracy sites",
        category: "content",
      },
      ...
      doh: {
        ...
        description: "Blocks encrypted DNS servers",
        category: "security",
      },
      dyndns: {
        name: "Hagezi Dynamic DNS",
        description: "Blocks dynamic DNS services",
        category: "security",
      },
      hoster: {
        name: "Hagezi Badware Hoster",
        description: "Blocks known badware hosters",
        category: "security",
      },
      urlshortener: {
        name: "Hagezi URL Shortener",
        description: "Blocks URL shorteners",
        category: "security",
      },
      nosafesearch: {
        name: "Hagezi No Safesearch",
        description: "Blocks search engines without Safesearch",
        category: "content",
      },
    };
